...
public class Registry {
    ...
    public static final RegistryObject<Item> PARTIAL_IRIDIUM_HOE_2_1 = registerItem("partial_iridium_hoe_1", () -> new HoeItem(IridiumToolTier.HALF, -1, 0.0F, (new Item.Properties()).fireResistant()));


    public static final RegistryObject<Item> PARTIAL_IRIDIUM_HELMET_5_1 = registerItem("partial_iridium_helmet_1", () -> new PartialIridiumArmorItem(IridiumArmorMaterial._5_2, EquipmentSlotType.HEAD, (new Item.Properties()).fireResistant(), 5, 1));
    public static final RegistryObject<Item> PARTIAL_IRIDIUM_HELMET_5_2 = registerItem("partial_iridium_helmet_2", () -> new PartialIridiumArmorItem(IridiumArmorMaterial._5_1, EquipmentSlotType.HEAD, (new Item.Properties()).fireResistant(), 5, 2));
