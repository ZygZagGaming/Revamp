package com.zygzag.revamp.registry;

import com.zygzag.revamp.Revamp;
import com.zygzag.revamp.block.GrateBlock;
import com.zygzag.revamp.block.IridiumOreBlock;
import com.zygzag.revamp.entity.EmpoweredWither;
import com.zygzag.revamp.entity.ThrownTransmutationBottle;
import com.zygzag.revamp.item.EmpowermentStar;
import com.zygzag.revamp.item.EnchantedBowlFoodItem;
import com.zygzag.revamp.item.ShulkerBowlItem;
import com.zygzag.revamp.item.TransmutationBottle;
import com.zygzag.revamp.item.enchant.CooldownEnchantment;
import com.zygzag.revamp.item.iridium.*;
import com.zygzag.revamp.item.iridium.partial.*;
import com.zygzag.revamp.item.recipe.EmpowermentRecipe;
import com.zygzag.revamp.item.recipe.ShulkerBowlRecipe;
import com.zygzag.revamp.item.recipe.TransmutationRecipe;
import com.zygzag.revamp.item.tier.IridiumArmorMaterial;
import com.zygzag.revamp.item.tier.IridiumToolTier;
