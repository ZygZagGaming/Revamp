...
public class PartialIridiumAxe extends AxeItem {
    int numberOfPlates;
    int maxNumOfPlates;
    public PartialIridiumAxe(Tier tier, int damage, float speed, Properties properties, int maxNumOfPlates, int numberOfPlates) {
