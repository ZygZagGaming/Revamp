...
import com.zygzag.revamp.common.block.tile.CustomCauldronTileEntity;
...
public class CustomCauldronBlock extends Block {
    ...
    public CustomCauldronBlock() {
        super(Properties.of(Material.METAL, MaterialColor.STONE).requiresCorrectToolForDrops().strength(2.0F).noOcclusion());
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new CustomCauldronTileEntity();
    }
