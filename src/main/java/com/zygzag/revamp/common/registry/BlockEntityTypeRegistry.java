...
public class BlockEntityTypeRegistry extends Registry<BlockEntityType<?>> {
    ...
    public static RegistryObject<BlockEntityType<ChargeDetectorBlockEntity>> CHARGE_DETECTOR_BLOCK_ENTITY = INSTANCE.register("charge_detector", () -> BlockEntityType.Builder.of(ChargeDetectorBlockEntity::new, BlockRegistry.CHARGE_DETECTOR.get()).build(null));
