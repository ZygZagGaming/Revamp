...
public class EntityRegistry extends Registry<EntityType<?>> {
    ...
    public static final RegistryObject<EntityType<ThrownGloidBall>> THROWN_GLOID_BALL = INSTANCE.register("gloid_ball", () -> EntityType.Builder.<ThrownGloidBall>of(ThrownGloidBall::new, MobCategory.MISC).sized(0.25f, 0.25f).build("gloid_ball"));
    ...
    public static final RegistryObject<EntityType<CannonFiredShulkerBullet>> CANNON_SHULKER_BULLET = INSTANCE.register("cannon_shulker_bullet", () -> EntityType.Builder.<CannonFiredShulkerBullet>of(CannonFiredShulkerBullet::new, MobCategory.MISC).sized(0.3125f, 0.3125f).build("cannon_shulker_bullet"));
    public static final RegistryObject<EntityType<GloidBubbleEntity>> GLOID_BUBBLE = INSTANCE.register("gloid_bubble", () -> EntityType.Builder.<GloidBubbleEntity>of(GloidBubbleEntity::new, MobCategory.MISC).sized(0.3125f, 0.3125f).build("gloid_bubble"));
