...
public class BlockRegistry extends Registry<Block> {
    ...
    public static final RegistryObject<Block> CHISELED_SHULKSTONE_BLOCK = INSTANCE.register("chiseled_shulkstone_block", () -> new ChiseledShulkstoneBlock(BlockBehaviour.Properties.copy(Blocks.PURPUR_BLOCK).strength(200f, 1200f)));
