...
public class PartialIridiumPickaxe extends PickaxeItem {
    int numberOfPlates;
    int maxNumOfPlates;
    public PartialIridiumPickaxe(Tier tier, int damage, float speed, Properties properties, int maxNumOfPlates, int numberOfPlates) {
